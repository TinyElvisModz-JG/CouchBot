...
namespace MTD.CouchBot.Domain
{
    public static class Constants
    {
        ...
        public static readonly string DefaultOfflineMessage = "This stream is now offline.";
        public static readonly string DefaultLiveMessage = "%CHANNEL% just went live with %GAME% - %TITLE% - %URL%";
        public static readonly string DefaultPublishedMessage = "%CHANNEL% just published a new video - %TITLE% - %URL%";
        public static readonly string DefaultGreetingMessage = "Welcome to the server, %USER%";
        public static readonly string DefaultGoodbyeMessage = "Good bye, %USER%, thanks for hanging out!";
    }
}
